...
public class CuentaEntidadFinancieraConverter extends GenericConverter {

	public CuentaEntidadFinancieraModel convertCuentaEntidadFinancieraToCuentaEntidadFinancieraModel(
		...
		String descripcionMonedaIntegrada = cuentaEntidadFinanciera.getIsoMonedaCuentaEntidadFinanciera().concat(" - ")
				.concat(cuentaEntidadFinanciera.getDescripcionMonedaCuentaEntidadFinanciera());

		cuentaEntidadFinancieraModel.setIdentificadorCuentaEntidadFinanciera(
				cuentaEntidadFinanciera.getIdentificadorCuentaEntidadFinanciera());
		...
		cuentaEntidadFinancieraModel
				.setNumeroCuentaEntidadFinanciera(cuentaEntidadFinanciera.getNumeroCuentaEntidadFinanciera());
		cuentaEntidadFinancieraModel.setNombreEntidadFinanciera(cuentaEntidadFinanciera.getNombreEntidadFinanciera());
		cuentaEntidadFinancieraModel
				.setAcronimoEntidadFinanciera(cuentaEntidadFinanciera.getAcronimoEntidadFinanciera());
		cuentaEntidadFinancieraModel.setTipoEntidadFinanciera(cuentaEntidadFinanciera.getTipoEntidadFinanciera());
		cuentaEntidadFinancieraModel
				.setDescripcionCuentaEntidadFinanciera(cuentaEntidadFinanciera.getDescripcionCuentaEntidadFinanciera());
		cuentaEntidadFinancieraModel.setCodigoMoneda(cuentaEntidadFinanciera.getCodigoMoneda());
		cuentaEntidadFinancieraModel
				.setIsoMonedaCuentaEntidadFinanciera(cuentaEntidadFinanciera.getIsoMonedaCuentaEntidadFinanciera());
		cuentaEntidadFinancieraModel.setDescripcionMonedaCuentaEntidadFinanciera(
				cuentaEntidadFinanciera.getDescripcionMonedaCuentaEntidadFinanciera());
		...
		cuentaEntidadFinancieraModel.setCadenaSaldoContableActual(
				formatoImpresionDecimal(cuentaEntidadFinanciera.getSaldoContableActual(), 2));
		cuentaEntidadFinancieraModel.setCadenaSaldoDisponibleActual(
				formatoImpresionDecimal(cuentaEntidadFinanciera.getSaldoDisponibleActual(), 2));
