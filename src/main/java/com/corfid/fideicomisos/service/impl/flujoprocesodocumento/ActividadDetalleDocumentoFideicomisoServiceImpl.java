...
public class ActividadDetalleDocumentoFideicomisoServiceImpl extends AbstractService
	...
	public String getTituloActividadesDetalleDocumentoFideicomiso(Integer identificadorDocumentoFideicomiso) {
		...
		String cadenaTituloActividadesDetalleDocumentoFideicomiso = "FORMALIZACION CONTRACTUAL  /  ";
		...
		descripcionDocumento = documentoFideicomiso.getDescripcionDocumento();
		nombreFideicomiso = documentoFideicomiso.getFideicomiso().getNombreFideicomiso();

		cadenaTituloActividadesDetalleDocumentoFideicomiso = cadenaTituloActividadesDetalleDocumentoFideicomiso
				.concat(descripcionDocumento);
		cadenaTituloActividadesDetalleDocumentoFideicomiso = cadenaTituloActividadesDetalleDocumentoFideicomiso
				.concat("  /  ");
		cadenaTituloActividadesDetalleDocumentoFideicomiso = cadenaTituloActividadesDetalleDocumentoFideicomiso
				.concat(nombreFideicomiso);

		return cadenaTituloActividadesDetalleDocumentoFideicomiso;
